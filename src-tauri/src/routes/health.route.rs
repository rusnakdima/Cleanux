...
pub async fn crud_get_health_history(
  ...
  Ok(ResponseModel {
    ...
    message: "Health history retrieved".to_string(),
...
pub async fn crud_get_health_trends(
  ...
  if docs.len() < 2 {
    ...
    return Ok(ResponseModel {
      status: ResponseStatus::Success,
      message: "Health trends calculated".to_string(),
      data: DataValue::Object(serde_json::to_value(trend).unwrap_or_default()),
    });
  }
  ...
  Ok(ResponseModel {
    status: ResponseStatus::Success,
    message: "Health trends calculated".to_string(),
    data: DataValue::Object(serde_json::to_value(trend_entity).unwrap_or_default()),
  })
}
...
pub async fn crud_save_health_snapshot(
  ...
  Ok(ResponseModel {
    status: ResponseStatus::Success,
    message: "Health snapshot saved".to_string(),
